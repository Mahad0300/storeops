<?php
$pageTitle = "My Assigned Jobs - StoreOps CRM";
$activePage = "my-assigned-jobs";
$pageScript = "my-assigned-jobs";
require_once "includes/header.php";
?>

<div id="myAssignedJobsView" class="page-view-section active">
  <section class="hero-metrics-section">
    <div class="hero-header-row">
      <div>
        <h1 class="hero-title">My Assigned Jobs</h1>
        <p class="hero-subtitle">
          Personalized tracking of store locations, vendor charges, revenues, and net margins assigned to you
        </p>
      </div>
      <button
    ...
    <!-- 4 Financial & Job Metrics Cards for My Assigned Jobs -->
    <div class="storeops-kpi-row jobs-page-kpis">
      <div class="kpi-card">
        <div class="kpi-top-row">
          ...
          <span class="kpi-trend-pill up">+18.4% ↗</span>
        </div>
        <div class="kpi-bottom-content">
          <span class="kpi-card-title">MY TOTAL ORDERS</span>
          <span id="myJobsPageTotalCount" class="kpi-card-number">42</span>
        </div>
        <svg
      ...
      <div class="kpi-card">
        <div class="kpi-top-row">
          ...
          <span class="kpi-trend-pill blue">+24.1% ↗</span>
        </div>
        <div class="kpi-bottom-content">
          <span class="kpi-card-title">MY TOTAL REVENUE</span>
          <span id="myJobsPageTotalRevenue" class="kpi-card-number">$41,800</span>
        </div>
        <svg
          class="kpi-watermark-bg"
          viewBox="0 0 24 24"
      ...
      <div class="kpi-card">
        <div class="kpi-top-row">
          ...
          <span class="kpi-trend-pill down">-4.2% ↘</span>
        </div>
        <div class="kpi-bottom-content">
          <span class="kpi-card-title">MY VENDOR CHARGES</span>
          <span id="myJobsPageTotalVendorCharges" class="kpi-card-number">$14,200</span>
        </div>
        <svg
          class="kpi-watermark-bg"
          viewBox="0 0 24 24"
      ...
      <div class="kpi-card highlight-green">
        <div class="kpi-top-row">
          ...
          <span class="kpi-trend-pill up">+32.6% ↗</span>
        </div>
        <div class="kpi-bottom-content">
          <span class="kpi-card-title">MY NET PROFIT</span>
          <span id="myJobsPageTotalNetProfit" class="kpi-card-number">$27,600</span>
        </div>
        <svg
          class="kpi-watermark-bg"
          viewBox="0 0 24 24"
  ...
  <!-- Master Glassmorphic My Jobs Data Table Container -->
  <div class="jobs-table-card master-jobs-panel">
    ...
    <div class="jobs-filter-toolbar">
      <div class="toolbar-left-search">
        ...
        <input
          type="text"
          id="myJobsTableFilterSearch"
          placeholder="Filter your jobs by store, designation..."
      ...
      <div class="toolbar-filters-group">
        ...
        <div class="custom-dropdown-wrapper">
          <button
            type="button"
            id="myBtnStatusDropdown"
            class="toolbar-select-btn"
          >
            <span id="myLblStatusFilter">All Statuses</span>
            <svg
              width="12"
              height="12"
              viewBox="0 0 24 24"
          ...
          <div id="myStatusDropdownMenu" class="custom-popover-menu">
            <label class="popover-checkbox-item"
              ><input
                type="checkbox"
                value="Scheduled"
                class="my-filter-status-cb"
              />
        ...
        <!-- Priorities Filter -->
        <select id="myFilterUrgencySelect" class="toolbar-select">
        ...
        <!-- Users Filter -->
        <select id="myFilterUserSelect" class="toolbar-select">
        ...
        <!-- Payments Filter -->
        <select id="myFilterPaymentSelect" class="toolbar-select">
    ...
    <!-- Comprehensive My Assigned Jobs Table -->
    <div class="table-responsive">
      <table class="crm-table master-jobs-table">
        ...
        <tbody id="myJobsMasterTableBody">
          <!-- My Jobs Rows Rendered Dynamically via JS -->
        </tbody>
      </table>
    </div>
    ...
    <div class="table-pagination-footer">
      <span class="pagination-info" id="myJobsPaginationInfo"
        >Showing 1 to 10 of 10 Work Orders</span
      >
      <div class="pagination-controls">
        <button class="pagination-btn" id="btnPrevMyJobsPage" disabled>
          ‹ Prev
        </button>
        <span class="pagination-page-num" id="myJobsCurrentPageNum"
          >1</span
        >
        <button class="pagination-btn" id="btnNextMyJobsPage" disabled>
          Next ›
        </button>
      </div>
    </div>
