...
<html lang="en">
  ...
  <body>
    ...
    <!-- Main App Shell Window Container -->
      ...
      <aside class="crm-sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          >
            ...
            <span class="nav-badge yellow" id="vendorsCountBadge">15</span>
          </a>
        ...
        <!-- Sidebar Footer Active Account Profile & Logout -->
        <div class="sidebar-footer">
          ...
          <div class="sidebar-copyright">
            © 2026 StoreOps | Richmond Tech Solution
          </div>
        </div>
      </aside>

      <!-- RIGHT MAIN CRM CONTENT WORKSPACE -->
      <div class="crm-main-content">
        <!-- TRANSPARENT STICKY TOP HEADER BAR -->
